...
import TratamientoRed from '../modelos-3d/Obeso'
import TratamientoLiver from '../modelos-3d/Botella'
                ...
                <div className="model3">
                    <Canvas shadows={true} onPointerMissed={() => (setTooltipVisible1(false), setTooltipVisible2(false))}>
                        ...
                        <Html position={[-1.7, 0.6, 0]} className='html3d'>
                            ...
                            <p className='text3d'>
                                El cáncer de hígado es una enfermedad oncológica que requiere tratamiento inmediato y agresivo, ya que su progresión puede ser rápida y potencialmente mortal. El tratamiento se centra en eliminar completamente el tumor cuando es posible mediante cirugía, controlar su crecimiento y diseminación con terapias sistémicas, aliviar los síntomas asociados y preservar la función hepática restante para mantener la calidad de vida del paciente.
                                <br />
                      ...
                      <Textohtml
                            ...
                            buttontext="La resección quirúrgica es el tratamiento más efectivo, removiendo la parte afectada del hígado. Ofrece mejores posibilidades de curación en etapas tempranas del cáncer."
                        ...
                        <Textohtml
                            ...
                            buttontext="La obesidad causa acumulación de grasa en el hígado (hígado graso), generando inflamación crónica y cicatrización que puede evolucionar a cirrosis y posteriormente a cáncer hepático..."
